...
class ProductoControlador:
    @staticmethod
    def registrar_producto(codigo, precio, pagina):
        try:
            ...
            Producto.create(codigo=codigo.strip(), precio=precio_float, pagina=pagina_int)
    ...
    def listar_productos(busqueda=None):
        try:
            ...
            return [(producto.id, producto.pagina, producto.codigo, producto.precio) for producto in query]
        except Exception as e:
    ...
    @staticmethod
    def actualizar_producto(id, codigo, precio, pagina):
        try:
            # Validar que la página sea un entero válido
            try:
                pagina_int = int(pagina)
    ...
    def eliminar_todos():
        try:
            ...
            return False, f"Error al eliminar todos los productos: {e}"